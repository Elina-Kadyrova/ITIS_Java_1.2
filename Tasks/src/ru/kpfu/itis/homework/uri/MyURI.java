   ...
   /* @Override
    public int compareTo(Object o) {
        if (getClass() == o.getClass()){
            URI ob = (URI) o;
            int result = 0;
            result = sortURI(this, ob);
            return result;
        }
        else{
            throw new IllegalArgumentException("Object is not an URI");
        }
    }

    public int sortURI(URI a, URI b){
        int result = 1;
        String[] arr1 = new String[] {a.getScheme(), a.getUser(), a.getPass(), a.getHost(), Integer.toString(a.getPort()), a.getPath(),
                a.getQuery(), a.getFragment()};
        String[] arr2 = new String[] {b.getScheme(), b.getUser(), b.getPass(), b.getHost(), Integer.toString(getPort()), b.getPath(),
                b.getQuery(), b.getFragment()};
